...
app.factory('registrationService', ['$http', '$routeParams', 'ngAuthSettings', function ($http, $routeParams, ngAuthSettings) {
    ...
    var _uploadUserCV = function (id, uploadData) {
        //return $http.put(serviceBase + 'api/user/' + id + '/userCV', uploadData).then(function (results) {
        return $http.post(serviceBase + 'api/user/' + id + '/userCV', uploadData).then(function (results) {
            return results;
        });
    };

    var _sendRecommendations = function (id, data) {
        //return $http.put(serviceBase + 'api/user/' + id + '/recommendation', data).then(function (results) {
    ...
    var _getLecturesTree = function (eventCode, couponCode) {
        var apiPath = serviceBase + 'api/event/' + eventCode + '/lecturesTree';
    ...
    var _uploadCvForm = function (id, uploadData) {
        //return $http.put(serviceBase + 'api/user/' + id + '/userCvForm', uploadData).then(function (results) {
        return $http.post(serviceBase + 'api/user/' + id + '/userCvForm', uploadData).then(function (results) {
            return results;
        });
    };

    var _uploadUserCVPicture = function (id, uploadData) {
        //return $http.put(serviceBase + 'api/user/' + id + '/UserCvPicture', uploadData).then(function (results) {
        return $http.post(serviceBase + 'api/user/' + id + '/userCvPicture', uploadData).then(function (results) {
            return results;
        });
    };

    var _activateAccount = function (token) {
        //return $http.put(serviceBase + 'api/account/confirmEmail?id=' + token).then(function (results) {
    ...
    var _updateUserData = function (uploadData) {
        //return $http.put(serviceBase + 'api/user/userData', uploadData).then(function (results) {
    ...
    var _saveReservation = function (id, choice) {
        //return $http.put(serviceBase + 'api/user/lecture/' + id + '/' + choice).then(function (results) {
    ...
    var _uploadCvInfo = function (id, uploadData) {
        return $http.post(serviceBase + 'api/user/' + id + '/cvAdditionalInfo', uploadData).then(function (results) {
            return results;
        });
    };
    ...
    var _getPackages = function (eventCode) {
        ...
        return $http.get(serviceBase + 'api/event/' + eventCode + '/lectureTags').then(function (results) {
            return results;
        });
    };
    ...
    var _getLecturesTreeWithFilter = function (eventCode, inEnglish, tags, couponCode) {
        if (inEnglish == "null")
            inEnglish = "";
        var apiPath = serviceBase + 'api/event/' + eventCode + '/lecturesTree?inEnglish=' + inEnglish + '&tags=' + tags;
        if (couponCode != null && couponCode != 'undefined')
            apiPath = apiPath + '&couponCode=' + couponCode;
        return $http.get(apiPath).then(function (results) {
            return results;
    ...
    var _getIsPackageFree = function (eventCode, selectedId) {
        return $http.get(serviceBase + 'api/event/' + eventCode + '/isFreePackage/' + selectedId).then(function (results) {
            return results;
        });
    };

    var _getIsOrgPackage = function (eventCode, selectedId) {
        return $http.get(serviceBase + 'api/event/' + eventCode + '/isOrgPackage/' + selectedId).then(function (results) {
            return results;
        });
    };
    ...
    var _getIsPackageAvailable = function (eventCode, packageCode) {
        return $http.get(serviceBase + 'api/event/' + eventCode + '/packages/' + packageCode + '/checkLimit').then(function (results) {
            return results;
        });
    };
    ...
    registrationServiceFactory.getIsPackageFree = _getIsPackageFree;
    registrationServiceFactory.getIsOrgPackage = _getIsOrgPackage;
